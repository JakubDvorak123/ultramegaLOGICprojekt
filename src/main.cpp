...
//     while(true)
//     {
//         const auto pressBUT = buttons.readAll();

//         display.drawSquare(pos.x, pos.y, 3, Rgb(255, 0, 0));
        
//         display.show(val);
//         delay(150);
//         display.clear();
     
//         if(pressBUT[R_Left]) pos.x++;
//         if(pressBUT[R_Right]) pos.x--;

//         if(pressBUT[L_Left] && val >= min)
//         {
//             val--;
//         }
//         if(pressBUT[L_Right] && val <= max)
//         {
//             val++;
//         }
